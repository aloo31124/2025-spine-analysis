...
description: >
  ...
  `.Codex/skills/log-report/report/Q{季}.工作.md`：先把新 commit 的 git title
...
1. **定位當季報告**：由今天日期決定季別（Q1=1–3、Q2=4–6、Q3=7–9、Q4=10–12），
   檔案為 `.Codex/skills/log-report/report/Q{季}.工作.md`。不存在則照本檔「週回顧格式」與既有報告結構新建。
...
pwsh .Codex/skills/log-report/scripts/log-report-helper.ps1 -Mode titles
# 算某週一～週五的「日期 週X」
pwsh .Codex/skills/log-report/scripts/log-report-helper.ps1 -Mode week -Monday 2026-06-08
# 建備份分支並 cherry-pick（會動 git 狀態，先取得使用者確認）
pwsh .Codex/skills/log-report/scripts/log-report-helper.ps1 -Mode backup -NewBranch 755-temp-0605 -Commits "<舊hash>,<...>,<新hash>"
```
