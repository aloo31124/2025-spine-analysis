...
description: >
  依「最新一份測試步驟清單」（.Codex/skills/spec-cypress-checklist/checklist/{yyyymmdd}_測試步驟清單.md）
...
pwsh .Codex/skills/spec-cypress-optimize/scripts/cypress-optimize-helper.ps1 -Mode pending
# 既有 cypress/e2e 檔清單（判斷擴充既有或新建）
pwsh .Codex/skills/spec-cypress-optimize/scripts/cypress-optimize-helper.ps1 -Mode specs
# 斷言原文（沿用 spec-cypress-checklist 的 helper）
pwsh .Codex/skills/spec-cypress-checklist/scripts/spec-cypress-helper.ps1 -Mode scenarios -Spec 013
```
