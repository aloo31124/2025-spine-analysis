...
固定路徑 `.Codex/skills/spec-cypress-checklist/checklist/{yyyymmdd}_測試步驟清單.md`（當日重跑覆寫同檔）。
...
pwsh .Codex/skills/spec-cypress-checklist/scripts/spec-cypress-helper.ps1 -Mode inventory
# 既有 cypress describe/context/it 清單
pwsh .Codex/skills/spec-cypress-checklist/scripts/spec-cypress-helper.ps1 -Mode cypress
